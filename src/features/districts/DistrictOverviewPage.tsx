...
export function DistrictOverviewPage() {
  ...
  return (
    <AppShell className="district-page-shell">
      <main className="district-overview-route">
        <DistrictMap activeDistrictId={districtId} />
        <div className="district-route-pill">{districtContent.representative}</div>
        <section className="district-bottom-sheet" aria-label="District overview">
